...
//        System.out.println(a +" " + b);
        rule=Integer.valueOf((input.substring(a, b)).trim());
        
        a=b; b=input.indexOf(" ",a+1);
//        System.out.println(a +" " + b);
        iterations = Integer.valueOf((input.substring(a, b)).trim());
        
        a=b; b=input.indexOf(" ",a+1);
//        System.out.println(a +" " + b);
        no_of_cells = Integer.valueOf((input.substring(a, b)).trim());
        
        a=b; b=input.indexOf(" ",a+1);
//        System.out.println(a +" " + b);
        initial_cell_state = Long.valueOf((input.substring(a)).trim());
        initial_cell_state = Long.valueOf(Long.toBinaryString(initial_cell_state));
...
//            x=x.trim();
//            initial_cell_state=Integer.parseInt(x);
//        }
        
//        System.out.println(rule +" " + iterations + " " + no_of_cells + " " + initial_cell_state);
